...
$(document).ready(function() {
    ...
    for (var n = 0; n < e.length; n++) {
        var o = '<iframe allowtransparency="true" frameborder="0" scrolling="no"src="https://platform.twitter.com/widgets/tweet_button.html?url=' + encodeURIComponent(window.location) + "&amp;text=" + encodeURIComponent(document.title) + '&amp;via=MicticulousC&amp;hashtags=MckerleyMatrimony&amp;count=horizontal"style="width:105px; height:21px;"><iframe src="https://www.facebook.com/plugins/like.php?href=https%3A%2F%2Fmckerley.wedding&width=450&layout=standard&action=like&size=small&share=true&height=35&appId" width="450" height="35" style="border:none;overflow:hidden" scrolling="no" frameborder="0" allowfullscreen="true" allow="autoplay; clipboard-write; encrypted-media; picture-in-picture; web-share"></iframe></iframe><div class="g-plusone" data-size="medium"></div>';
